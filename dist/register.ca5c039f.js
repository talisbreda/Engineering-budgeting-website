...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"register.ts":[function(require,module,exports) {
"use strict";
...
form.addEventListener('submit', function (event) {
  return __awaiter(void 0, void 0, void 0, function () {
    var nome, email, senha, confirm, todo, response, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          event.preventDefault();
          nome = document.querySelector('#nameInputData').value;
          email = document.querySelector('#emailInputData').value;
          senha = document.querySelector('#passwordInputData').value;
          confirm = document.querySelector('#confirmationInputData').value;
          todo = {
            nome: nome,
            email: email,
            senha: senha
          };
          if (!(nome.length > 0)) return [3
          /*break*/
          , 15];
          if (!email.includes('@', '.com')) return [3
          /*break*/
          , 13];
          if (!(email.length > 6)) return [3
          /*break*/
          , 11];
          if (!(senha == confirm)) return [3
          /*break*/
          , 9];
          if (!(senha.length > 5)) return [3
          /*break*/
          , 7];
          if (!(senha.length < 19)) return [3
          /*break*/
          , 5];
          _a.label = 1;
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , axios_1.default.post("".concat(base_url, "/register"), todo)];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","register.ts"], null)
//# sourceMappingURL=/register.ca5c039f.js.map