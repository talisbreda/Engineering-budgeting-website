...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"edit.ts":[function(require,module,exports) {
"use strict";
...
var qtd_piso = document.querySelector('#qtd_piso');
var qtd_argamassa = document.querySelector('#qtd_argamassa');
var qtd_telha = document.querySelector('#qtd_telha');
var qtd_tinta = document.querySelector('#qtd_tinta');
var custo_areia = document.querySelector('#custo_areia');
var custo_tijolo = document.querySelector('#custo_tijolo');
var custo_piso = document.querySelector('#custo_piso');
var custo_cimento = document.querySelector('#custo_cimento');
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          lado_b = parseFloat(inputs[1].value);
          lado_c = parseFloat(inputs[2].value);
          lado_d = parseFloat(inputs[3].value);
          altura = parseFloat(inputs[4].value);
          material_parede = inputs[5].value;
          cimento = inputs[6].value;
          tipo_piso = inputs[7].value;
          tamanho_piso = inputs[8].value;
          argamassa = inputs[9].value;
          material_telhado = inputs[10].value;
          cor_telhado = inputs[11].value;
          ondas_telhado = inputs[12].value;
          tipo_acabamento = inputs[13].value;
          cor_tinta = inputs[14].value;
          titulo_projeto = inputs[15].value;
          todoGeral = {
            id: idProjeto,
          ...
          return [4
          /*yield*/
          , axios_1.default.put("".concat(base_url, "/update/project"), todoGeral)];

        case 1:
          responseGeral = _a.sent();
          area_piso = lado_a * lado_b;
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","edit.ts"], null)
//# sourceMappingURL=/edit.22165be8.js.map